...
const Login = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center">
      <div className="flex w-[137px] justify-between h-[40px] items-left self-left mr-auto ml-[125px] mt-[130px] mb-[50px] text-center">
        <svg
        ...
        <h1 className="font-inter font-bold text-black text-center">
          HelpMeOut
        </h1>
      </div>
      <div className="w-full max-w-[475px] h-[599px] flex flex-col gap-8 justify-center items-center align-center mt-5 mb-[125px] px-4">
        ...
        <div className="w-full h-[120px] flex flex-col justify-between">
          ...
          <button className="w-full h-[48px] flex justify-center items-center gap-2 border rounded-xl border-primary">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g id="Facebook svg" clipPath="url(#clip0_205_4761)">
                <g id="g10">
                  <g id="g12">
                    <path
                      id="path14"
