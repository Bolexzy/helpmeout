...
const Footer = () => {
  return (
    <footer className="w-full flex flex-col md:flex-row justify-center gap-5 lg:justify-between flex-wrap py-[98px] bg-[#120B48] lg:px-[100px] md:px-8 px-[20px] mt-[150px]">
      ...
      <div className="flex flex-col gap-1 md:gap-[26px]">
        <p className="text-[#FFF] font-[Sora] font-[600] font-[16px]">Menu</p>
        <p className="text-[#FFF] font-[Work Sans] font-[400] font-[16px]">
          Home
        </p>
        <p className="text-[#FFF] font-[Work Sans] font-[400] font-[16px]">
          Converter
      ...
      <div className="flex flex-col gap-1 md:gap-[26px]">
        <p className="text-[#FFF] font-[Sora] font-[600] font-[16px]">
          About Us
        </p>
        <p className="text-[#FFF] font-[Work Sans] font-[400] font-[16px]">
          About
